...
public class ClassOnAbstractClassOnInterfaceTest {
    ...
    @ManualValidation
    public abstract static class EmptyIntermediate implements WithScrambler {
    }
    @ManualValidation
    ...
    public abstract static class IntermediateWithRequirements implements WithScrambler {
    }
    @ManualValidation
